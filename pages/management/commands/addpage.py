...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        text_home = """The system is open source, written using the Django framework in thу Python 
            programming language. This cms allows you to make a website in minutes. 
